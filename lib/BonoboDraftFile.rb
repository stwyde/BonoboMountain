...
bot = Discordrb::Bot.new token: ENV['bonobo_discord_api_key'], client_id: ENV['client_id']

puts "This bot's invite URL is #{bot.invite_url}."
puts 'Click on it to invite it to your server.'

bot.message(with_text: 'bonobo competitors?') do |event|
  event.respond '<Affirmedwin123>, <AtlasPrym9x>, <VgSuper99>, <MagicMelon33> <GruntMaster99>'
end
